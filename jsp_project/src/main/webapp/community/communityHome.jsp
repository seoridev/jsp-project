...
<main class="page-shell community-shell">
    ...
    <form class="cafe-search-bar" action="<%= contextPath %>/community/cafe/cafeList.jsp" method="get">
        <strong>카페 검색</strong>
    ...
    <section class="cafe-portal-grid">
        <aside class="cafe-box">
            ...
            <nav class="cafe-category-list" aria-label="카페 카테고리">
                <a href="<%= contextPath %>/community/cafe/cafeList.jsp?category=동네소식">동네소식</a>
                <a href="<%= contextPath %>/community/cafe/cafeList.jsp?category=맛집">맛집</a>
                <a href="<%= contextPath %>/community/cafe/cafeList.jsp?category=반려동물">반려동물</a>
                <a href="<%= contextPath %>/community/cafe/cafeList.jsp?category=취미">취미</a>
                <a href="<%= contextPath %>/community/cafe/cafeList.jsp?category=육아">육아</a>
            </nav>
        </aside>
        ...
        <section class="cafe-box">
            <div class="cafe-section-title">
                <span>인기 카페</span>
                <a class="btn-text" href="<%= contextPath %>/community/cafe/cafeList.jsp?sort=popular">전체보기</a>
            </div>
            <div class="cafe-rank-list">
                <% int rank = 1; %>
                <% for (CafeDTO cafe : popularCafes) { %>
                    <a class="cafe-rank-item" href="<%= contextPath %>/community/cafe/cafeDetail.jsp?cafeId=<%= cafe.getCafeId() %>">
        ...
        <aside class="cafe-box cafe-info-box">
            ...
            <div class="cafe-box-body cafe-action-stack">
                ...
                <% } %>
                <a class="button btn-sub" href="<%= contextPath %>/community/cafe/cafeList.jsp">카페 둘러보기</a>
